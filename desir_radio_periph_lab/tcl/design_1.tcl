...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins full_radio_0/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  [get_bd_pins lowlevel_dac_intfc_0/data_word]
  connect_bd_net -net full_radio_0_m_axis_tvalid  [get_bd_pins full_radio_0/m_axis_tvalid] \
  [get_bd_pins lowlevel_dac_intfc_0/valid]
  connect_bd_net -net lowlevel_dac_intfc_0_bclk  [get_bd_pins lowlevel_dac_intfc_0/bclk] \
  [get_bd_ports bclk]
  connect_bd_net -net lowlevel_dac_intfc_0_latched_data  [get_bd_pins lowlevel_dac_intfc_0/latched_data] \
