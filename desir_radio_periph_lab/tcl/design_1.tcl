...
set AXI_STR_RXD_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 AXI_STR_RXD_0 ]
  ...
  set axi_str_rxd_tlast_0 [ create_bd_port -dir I axi_str_rxd_tlast_0 ]

  # Create instance: full_radio_0, and set properties
  set full_radio_0 [ create_bd_cell -type ip -vlnv jhu.edu:user:full_radio:6.0 full_radio_0 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M01_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  connect_bd_net -net axis_broadcaster_0_s_axis_tready  [get_bd_pins axis_broadcaster_0/s_axis_tready] \
  [get_bd_pins full_radio_0/m_axis_tready]
  connect_bd_net -net full_radio_0_m_axis_tdata  [get_bd_pins full_radio_0/m_axis_tdata] \
  [get_bd_pins axis_broadcaster_0/s_axis_tdata]
  connect_bd_net -net full_radio_0_m_axis_tvalid  [get_bd_pins full_radio_0/m_axis_tvalid] \
  [get_bd_pins axis_broadcaster_0/s_axis_tvalid]
